...
//#define FILEACTIONINPUTBUFFER		"/dev/shm/cdat-readinputoutput-iobuf"
//#define FILEACTIONINPUTCOUNTER		"/dev/shm/cdat-readinputoutput-count"
#define FILEACTIONCOMMANDFILEARGS	"/dev/shm/cdat-fileaction-args"
#define FILEACTIONCOMMANDFILELIST	"/dev/shm/cdat-fileaction-list"
#define FILEACTIONCOMMANDLISTCAT	"-- /dev/shm/cdat-fileaction-list"
...
//          cursorlinebreak(KEYOUTINDEX);
        ...
        messagecount = (messagecount + 1) % 1000000; // <------------------- resets!
#ifdef KEYBOXENABLED
